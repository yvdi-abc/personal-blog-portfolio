    ...
    <CardContainer className="w-full h-full">
      <CardBody className="w-full h-full">
        ...
        >
          <div
            onClick={toggleTheme}
            className={`h-full w-full rounded-3xl backdrop-blur-md border shadow-xl p-6 flex flex-col justify-center items-center transition-all duration-500 cursor-pointer group relative overflow-hidden
          ...
          >
             ...
             <CardItem
               translateZ="100"
               rotateZ="5"
               className="relative w-20 h-20 rounded-full overflow-hidden mb-3 shadow-inner flex-shrink-0"
             >
             ...
             <div className="text-center z-10 mt-auto">
                 <CardItem translateZ="80" as="h3" className={`text-xl font-bold transition-colors duration-500 ${isDark ? 'text-white' : 'text-slate-800'}`}>
                   {isDark ? '夜间模式' : '日间模式'}
                 </CardItem>
                 <CardItem translateZ="60" as="p" className={`text-sm font-medium mt-1 transition-colors duration-500 ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
