          ...
          >
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-end z-20">
              <CardItem translateZ="60" className="flex items-center gap-2 mb-2">
                <span className="px-3 py-1 bg-rose-500/80 backdrop-blur-lg rounded-full text-[10px] text-white font-black uppercase tracking-widest shadow-lg">
                  Contact
                </span>
              </CardItem>
              <CardItem translateZ="80" as="h3" className="text-3xl font-bold text-white mb-2 underline decoration-rose-400">
                联系我
              </CardItem>
